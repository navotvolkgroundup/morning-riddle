...
// `sched` is the WHOLE household: one timetable per child, indexed the same
// way kids_turn_today() indexes. The page draws the one belonging to whoever
// the rotation named this morning.
